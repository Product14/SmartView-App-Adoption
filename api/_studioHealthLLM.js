...
// Turns the deterministic facts (from src/data/studioInsights.js) into short
// editorial prose. This is an ENHANCEMENT layer only: it returns null on any
// problem (no key, non-200, timeout, bad JSON) and the caller falls back to the
// templated commentary, so the email never breaks or stalls.
//
